    ...
    protected function contractsProvider()
    {
        return [
            [
                ...
                'method' => 'GET',
                'url' => 'statsAgg?query={"fields":["advertiser_id"],"filters":{"advertiser_id":{"relation":"in","sets":[1,2]},"date":{"relation":"between","sets":["2016-01-01","2016-12-31"]}},"groups":["advertiser_id"],"groupDefaultNumber":0,"orders":{"date":"desc"},"page":0,"limit":100}',
                'headers' => '',
                'request' => '',
